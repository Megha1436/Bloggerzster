...
<head>
    ...
    <style>
        ...
        .heading{
            ...
            margin: 6px;
            text-shadow: 1px 1px 2px black, 0 0 25px rgb(255,0,0), 0 0 5px rgb(139,0,0);
        }
        .container{
            display : flex;
...
<div class="heading_content">
    <i onclick="location.href='{{ url('adventure') }}'"><i style="font-size:30px; margin: 15px 10px; color: white;" class="fas fa-arrow-circle-left"></i></i>
    <i onclick="location.href='{{ url('events') }}'"><i style="font-size:30px; margin: 15px 10px; color: white;" class="fas fa-arrow-circle-right"></i></i>
    <h1 class="heading"><b>FOODIE</b></h1>
    <div style="margin-left:400px; margin-top:20px;"  class="uk-button-group">
			<div class="uk-inline">
