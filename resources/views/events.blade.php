...
<head>
    ...
    <style>
        ...
        .heading{
            ...
            margin: 6px;
            text-shadow: 1px 1px 2px black, 0 0 25px rgb(30,144,255), 0 0 5px 	rgb(0,0,128);
        }
        .container{
            display : flex;
...
<div class="heading_content">
    <i onclick="location.href='{{ url('foodie') }}'"><i style="font-size:30px; margin: 15px 10px; color: white;" class="fas fa-arrow-circle-left"></i></i>
    <i onclick="location.href='{{ url('contact') }}'"><i style="font-size:30px; margin: 15px 10px; color: white;" class="fas fa-arrow-circle-right"></i></i>
